...
export default function StudioTopbar() {
  ...
  const download = (fmt: 'png'|'jpeg', scale: 1|2) => {
    const url = exportImage(fmt, scale); const a = document.createElement('a');
    a.href = url; a.download = `${doc?.title || 'design'}.${fmt}`; a.click();
  };
  return (
